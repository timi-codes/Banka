...
function () {
  ...
  (0, _createClass2["default"])(UserController, null, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                return _context.abrupt("return", response.sendSuccess(res, 201, createdUser, 'Registration was successful'));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                return _context2.abrupt("return", response.sendSuccess(res, 200, user, 'Login was successful'));
    ...
    key: "createStaff",
    value: function () {
      var _createStaff = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.prev = 1;
                _context3.next = 4;
                return _user["default"].createAStaff(user);
              ...
              case 4:
                ...
                return _context3.abrupt("return", response.sendSuccess(res, 201, createdUser, 'Staff created successfully'));
