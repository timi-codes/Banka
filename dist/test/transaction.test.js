...
describe('Test transaction related endpoints - Debit and Credit an account', function () {
  ...
  */
  ...
  describe('POST /transactions/:accountNumber/debit', function () {
    ...
    it('it throws an error if account number is invalid', function (done) {
      var accountNumber = '2220107727hsds.fjd';
      var body = {
        amount: 500
      };
  ...
  describe('GET accounts/:accountNumber/transactions', function () {
    ...
    it('it should throw an error when account number is not valid', function (done) {
      var accountNumber = '2220107727hhd';
  ...
  describe('GET /transactions/:transactionId', function () {
    ...
    it('it should throw an error when transaction id not valid', function (done) {
      var transactionId = '1f';
