...
function () {
  ...
  (0, _createClass2["default"])(AccountService, null, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                throw new Error("user already have a savings and current accounts - ".concat(account[0].accountnumber, " and ").concat(account[1].accountnumber, " "));
              ...
              case 11:
                ...
                throw new Error("user already have a ".concat(type, " account : ").concat(account[0].accountnumber));
    ...
    value: function () {
              ...
              case 7:
                ...
                return _context8.abrupt("return", accounts.map(function (account) {
                  var createdon = account.createdon,
                      ...
                      owner = account.owner,
                      data = (0, _objectWithoutProperties2["default"])(account, ["createdon", "accountnumber", "owner"]);
      ...
      function getAUserAccounts(_x11) {
