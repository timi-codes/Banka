          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return this.insert('email, firstName, lastName, type, isAdmin, password', '$1, $2, $3, $4, $5, $6', [user.email, user.firstName, user.lastName, user.type, user.isAdmin, user.password]);
